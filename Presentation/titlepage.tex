...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \centering
    {\Huge \textbf{\textcolor{black}{Survival Analysis}}}\\[1.5cm]
    \textsc{\LARGE Directed Project in Statistics}\\[0.5cm]
    \text{\large STAT 7892}\\[2cm]
    
    {\Large \textbf{\textcolor{tudelftdarkblue}{Authors:}}}\\[0.5cm]
    \begin{tabular}{c}
        \Large \textcolor{tudelftdarkblue}{Abel Villanueva} \\
    \end{tabular}\\[2cm]
    ...
    \vfill
    \begin{center}
        \includegraphics[width=0.6\textwidth]{images/uncc.png}
    \end{center}
\end{titlepage}